...
```
TOGOGO-flag{0a27a4ef-ec09-49fd-902c-5684e65a51e8}
```
...
```bash
python3 main.py                       # 用内置默认地址
python3 main.py http://host:port      # 自定义
```
